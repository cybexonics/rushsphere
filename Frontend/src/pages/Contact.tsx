...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://rushsphere.onrender.com/api/send-email", {
        ...
        subject,
        message:`<h1>${name}</h1><br/><p>${message}</p>`,
      });
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto rounded-md shadow-md">
      ...
      <div className="mb-4">
          ...
          <input
            type="text"
            className="w-full px-3 py-2 text-black rounded border border-black"
            value={name}
