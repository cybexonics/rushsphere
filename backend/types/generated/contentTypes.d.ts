...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address_1: Schema.Attribute.String & Schema.Attribute.Required;
    address_2: Schema.Attribute.String;
    cart: Schema.Attribute.JSON & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    order_no: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zip_code: Schema.Attribute.BigInteger & Schema.Attribute.Required;
  };
}
